...
add wave -noupdate -group {Datapath Signals} /system_tb/DUT/CPU/DP/EXflushed
...
add wave -noupdate -group {Datapath Signals} /system_tb/DUT/CPU/DP/MUX_XXX
...
add wave -noupdate -expand -group FU /system_tb/DUT/CPU/DP/fuif/id_ex_rs
add wave -noupdate -expand -group FU /system_tb/DUT/CPU/DP/fuif/id_ex_rt
add wave -noupdate -expand -group FU /system_tb/DUT/CPU/DP/fuif/MEMwsel
add wave -noupdate -expand -group FU /system_tb/DUT/CPU/DP/fuif/WBwsel
add wave -noupdate -expand -group FU /system_tb/DUT/CPU/DP/fuif/MEMRegWr
add wave -noupdate -expand -group FU /system_tb/DUT/CPU/DP/fuif/WBRegWr
add wave -noupdate -expand -group FU /system_tb/DUT/CPU/DP/fuif/forwardselA
add wave -noupdate -expand -group FU /system_tb/DUT/CPU/DP/fuif/forwardselB
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {4955393 ps} 0}
...
update
WaveRestoreZoom {4442502 ps} {5475642 ps}
